 ...
 */
final class Version20251205091236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_member (id INT AUTO_INCREMENT NOT NULL, vuris_role VARCHAR(20) NOT NULL, project_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_67401132166D1F9C (project_id), INDEX IDX_67401132A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
